...
function(xalan_thread_test outvar)
...
endfunction(xalan_thread_test)

xalan_thread_test(XALAN_HAVE_STD_THREAD)
if(XALAN_HAVE_STD_THREAD)
  list(APPEND xalan_threads standard)
endif()

if(TARGET Threads::Threads)
  if(WIN32)
    list(APPEND xalan_threads windows)
  else()
    list(APPEND xalan_threads posix)
    set(HAVE_PTHREAD 1)
  endif()
endif()
string(REPLACE ";" "|" thread_help "${xalan_threads}")
list(GET xalan_threads 0 xalan_thread_default)
set(thread "${xalan_thread_default}" CACHE STRING "Thread implementation (${thread_help})")
#set(thread "${xalan_thread_default}")
list(FIND xalan_threads "${thread}" thread_found)
